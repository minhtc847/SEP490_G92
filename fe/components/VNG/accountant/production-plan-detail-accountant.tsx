...
interface ProductionPlanDetailAccountantProps {
    onOrderCreated?: () => void;
}

const ProductionPlanDetailAccountant: React.FC<ProductionPlanDetailAccountantProps> = ({ onOrderCreated }) => {
    ...
    useEffect(() => {
        const fetchDetail = async () => {
            try {
                ...
                const mockDetail: ProductionPlanDetail = {
        ...
        return (
            <div className="panel mt-6">
                <div className="text-center py-8">
                    <p className="text-gray-500">Không tìm thấy thông tin kế hoạch sản xuất</p>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="panel mt-6">
            <div className="mb-6">
                <h2 className="text-xl font-semibold mb-4">Chi tiết kế hoạch sản xuất #{detail.id}</h2>
                
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    <div className="bg-gray-50 p-4 rounded-lg">
                        <h3 className="font-medium text-gray-700">Ngày lập kế hoạch</h3>
                        <p className="text-lg font-semibold">
                            {detail.planDate ? new Date(detail.planDate).toLocaleDateString('vi-VN') : '-'}
                        </p>
                    </div>
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                        ...
                        <span className={`badge ${getStatusBadge(detail.status)} text-sm`}>
            ...
            <div className="flex justify-end">
                <div className="bg-primary/10 p-4 rounded-lg">
                    <h3 className="font-semibold text-primary">Tổng giá trị kế hoạch</h3>
                    <p className="text-2xl font-bold text-primary">
                        {detail.totalValue.toLocaleString('vi-VN')} VNĐ
                    </p>
                </div>
            </div>
        </div>
...
export default ProductionPlanDetailAccountant;
