            ...
            <div className="datatables mt-8">
                <DataTable
                    ...
                    columns={[
                        ...
                        { accessor: 'glassLayers', title: 'Số kính', render: (r, idx) => <input type="number" min={0} max={MAX_VAL} step={1} value={r.glassLayers} onChange={e => handleChange(idx, 'glassLayers', e.target.value)} className="input input-sm w-20" disabled /> },
