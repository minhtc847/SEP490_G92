...
const ProductionOrdersDetailManagerComponent: React.FC = () => {
        ...
        const fetchDetail = async () => {
            try {
                ...
                const mockDetail: ProductionOrderDetail = {
                    ...
                    assignedEmployees: ['Nguyễn Văn A', 'Trần Thị B', 'Lê Văn C'],
    ...
    return (
        <div className="panel mt-6">
            <div className="mb-6">
                <h2 className="text-xl font-semibold mb-4">Chi tiết lệnh sản xuất #{detail.id} (Manager View)</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                        <h3 className="font-medium text-gray-700">Dự kiến hoàn thành</h3>
                        <p className="text-sm text-gray-600">
                            {detail.estimatedCompletion ? new Date(detail.estimatedCompletion).toLocaleDateString('vi-VN') : '-'}
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="mb-6">
                <h3 className="text-lg font-semibold mb-4">Nhân viên được phân công</h3>
                <div className="flex flex-wrap gap-2">
                    {detail.assignedEmployees.map((employee, index) => (
            ...
            <div className="mb-6">
                <h3 className="text-lg font-semibold mb-4">Danh sách sản phẩm và tiến độ</h3>
                                    ...
                                    <td>
                                        <div className="flex items-center gap-2">
                                            <div className="w-full bg-gray-200 rounded-full h-2">
                                                <div 
                                                    className={`h-2 rounded-full ${getProgressColor(product.progress)}`}
