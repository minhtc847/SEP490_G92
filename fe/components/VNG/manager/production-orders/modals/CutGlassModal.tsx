                                            ...
                                            <table className="table-striped w-full">
                                                ...
                                                <tbody>
                                                    {products.map((product, idx) => {
                                                        ...
                                                        const calculatedQuantity = selectedQuantity * glassLayers;
