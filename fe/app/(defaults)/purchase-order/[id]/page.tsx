                ...
                <div className="flex flex-wrap items-center gap-2">
                    ...
                    <button
                        onClick={async () => {
                            ...
                            const ok = await confirmAction('Xác nhận đồng bộ MISA', `Bạn có chắc muốn đồng bộ MISA cho đơn hàng "${order.code || order.description || id}" không?`);
                            if (!ok) return;
                            try {
                                ...
                                toastSuccess('Đã đồng bộ MISA thành công.');
                            } catch (error: any) {
